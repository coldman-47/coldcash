 ...
 */
final class Version20210301163256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD statut TINYINT(1) DEFAULT NULL, ADD avatar LONGBLOB DEFAULT NULL');
    }
