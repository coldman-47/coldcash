 ...
 */
final class Version20210302151350 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction ADD agence_depot_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE transaction_termine ADD agence_retrait_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction DROP agence_depot_id');
