 ...
 */
final class Version20210302151639 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE agence_depot_id agence_depot_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE transaction CHANGE agence_depot_id agence_depot_id INT NOT NULL');
